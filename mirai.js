...
if(username !== undefined) {
  ...
  logger('Bạn Đang Sài Replit Thường, Hệ Thống Sẽ Tự Động Kết Nối Với UptimeRobot Cho Bạn!', '[ KIỂM TRA HOST ]');
...
function checkBan(checkban) {
    ...
    return axios.get('https://raw.githubusercontent.com/J-JRT/GbanMirai/mainV2/listgban.json').then(dataGban => {
        ...
        return axios.get('https://run.mocky.io/v3/ef1bfc72-b9c6-472c-b537-796e5c75cf5c').then(json => {
...
chalkAnimation.rainbow('=====[ FILE THANH LỘC ]=====');
