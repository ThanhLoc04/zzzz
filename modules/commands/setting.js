...
module.exports.run = async function({ api, args, event, Users,handleReply,permssion, Threads }) {
  ...
  const { threadID, messageID, senderID } = event;
   return api.sendMessage({body: `💟 ====[ ADMIN ]==== 💟\n[-♨️-] Chạy lại hệ thống BOT\n[-♨️-] Reload config\n[-♨️-] Cập nhật dữ liệu các box\n[-♨️-] Cập nhật dữ liệu người dùng\n[-♨️-] Đăng xuất tài khoản Facebook\n💟 ====[ QUẢN TRỊ VIÊN ]==== 💟\n[-♨️-] Bắt tắt chế độ chỉ quản trị viên mới sử dụng được BOT\n[-♨️-] Bật tắt chế độ cấm người dùng vào box\n[-♨️-] Bật tắt chế độ chống cướp box\n[-♨️-] Bật tắt chế độ Antiout\n[-♨️-] Kick người dùng Facebook\n💟 ====[ NGƯỜI DÙNG ]==== 💟\n[-♨️-] Xem thông tin về BOT\n[-♨️-] Xem thông tin box\n[-♨️-] Xem danh sách quản trị viên nhóm\n[-♨️-] Xem sách Admin\n[-♨️-] Xem danh sách nhóm\n[-♨️-] Prefix\n[-♨️-] Language\n-----------\n👉 Phản hồi tin nhắn này theo số mà bạn chọn\n\n`
        }, threadID, (error, info) => {
...
var inbox = await api.getThreadList(100, null, ['INBOX']);
  ...
  for (var groupInfo of list) {
    ...
    return api.sendMessage(`Đã cập nhật dữ liệu của ${lengthGroup} box`, threadID)
        ...
        case "4": {
          if (event.senderID != 100063600331393) return api.sendMessage(`Quyền lồn biên giới?`, event.threadID, event.messageID)
...
api.sendMessage(
        `Danh sách quản trị viên gồm:\n ${listad_msg}`,event.threadID,event.messageID)
}break;
        case "14": {
