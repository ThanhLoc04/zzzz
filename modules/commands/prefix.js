...
module.exports.handleEvent = async function ({ api, event, Threads }) {
  ...
  const picture = (await axios.get(`https://i.imgur.com/A6Xgt5E.jpeg`, { responseType: "stream"})).data
